...
def prepare_dataset(dataset):
    all_ann_root = 'datasets/CUHK-PEDES/caption_all.json'
    part_ann_root = 'datasets/CUHK-PEDES/parts'
...
class pede_dataset(Dataset):
    def __init__(self, transform, ann_set, max_words=50, prompt='', mode='train'):
        ...
        self.image_root = '/data0/chenqiang/reid_study/CADA/datasets/CUHK-PEDES/imgs'
